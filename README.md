...
その色レリーフに必要な接着保持の承認は未確認のため、**追加作品の製作リリースは保留**です。
[追加作品の状態と境界](docs/tribute-release.md)を参照してください。原3案の無接着仕様は変わりません。
[追加作品のデジタル設計候補](https://ktanino10.github.io/copilot-brick-display/tribute/)は、保留表示付きの別ページで閲覧できます。
