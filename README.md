...
**[実物の制作記録：個人向けBが完成しました（2026-09-25）](docs/build-log.ja.md#build-2026-09-25)**
...
[ユーザー提供の後処理参考動画：超音波洗浄](docs/build-log.ja.md#post-print-cleaning)への外部リンクも掲載しています。
...
個人向けBの[制作過程と完成報告](docs/build-log.ja.md#build-2026-09-25)は写真付きで記録し、測定による物理試験とは区別しています。
