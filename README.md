...
**[実物の制作記録：Bの顔下部を組立中（2026-09-24）](docs/build-log.ja.md#build-2026-09-24)**

個人向けB版の台座・前面部品から顔下部へ進んだ途中記録です。[9/23の台座写真](docs/build-log.ja.md#build-2026-09-23)も残しています。
写真の紫・黄は実制作例の配色で、設計配色は不変更です。全150部品の完成・保持力の合格や、
...
個人向けBの台座・前面部品・顔下部の途中写真は[制作記録](docs/build-log.ja.md#build-2026-09-24)に追加しましたが、測定による物理試験とは区別しています。
