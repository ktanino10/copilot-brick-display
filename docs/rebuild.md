...
The face-only transform and all frozen tribute paths are checked against `design/revision3-invariants.json`.
The unselected tribute keeps its old pinned interface and must not be regenerated by this workflow.
