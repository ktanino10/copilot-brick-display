...
**[実物写真の制作記録：個人向けBの顔下部を組立中（09/24）](build-log.ja.md#build-2026-09-24)**。
9/23の台座・前面部品の記録も残しています。写真の紫・黄は実制作例の配色で、この3Dガイドのmagenta／greenは変更していません。
識別情報を伏せた進捗報告を以下の説明用3DCGと区別し、上部ゴーグル・頭頂や全150部品の完成、保持合格とは扱いません。
